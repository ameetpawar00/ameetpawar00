...
//echo "SELECT * FROM `post` WHERE `id` = '$id'";
$getData = mysql_query("SELECT * FROM `post` WHERE `id` = '$id'",$con) or die(mysql_error());
...
<button class="button green" onclick="SaveData('masters/post/update?id=<?php echo $id;?>&i=<?php echo $i;?>','dept','2','<?php echo $i;?>','','couResp','2');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i>Update</button>
