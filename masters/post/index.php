        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td colspan="4" style="text-align:center">
                    ...
                    <button class="button green" onclick="SaveData('masters/post/save','dept','2','','','couResp','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i>Save</button>
