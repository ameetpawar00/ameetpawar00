    ...
    <div class="add-new blue-border">
        <div class="form-head blue">
            <div class="head-title">
                <i class="add-form"></i>
                Download Salary Excel</div>
        </div>
        <form action="masters/salaryExcel/excelDownload.php" method="post" target="_blank" >
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align:center">
                        <button class="button green" name="excelDo" type="submit" ><i class="save-icon"></i>Excel Download </button>
                        &nbsp;
                        &nbsp;
                        &nbsp;
                        &nbsp;
