...
<button class="button yellow" onclick="getModule('masters/shift/shiftOld','manipulateContent','viewContent','Shift Old')"> <i class="plus"></i>2018 Shifts </button>&nbsp;
<button class="button green" onclick="getModule('masters/shift/allot_what','manipulateContent','viewContent','Shift')"> <i class="plus"></i>Allot Shift</button>&nbsp;
...
<button class="button red" onclick="deleteData('shift','shift')"> <i class="delete-icon"></i>Delete</button>&nbsp;&nbsp;<button class="button gray" onclick="getModule('masters/index','manipulateContent','viewContent','Setup');">
