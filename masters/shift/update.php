...
print_r($post);
mysql_query("UPDATE `shift` SET `name`='$post[0]', `starttime`='$post[1]', `endtime`='$post[2]', `fhdot`='$post[3]', `shdit`='$post[4]', `lcfhc`='$post[5]', `lcshc`='$post[6]', `modifieddate`='$datetime', `updatedby`='$hrmloggedid' WHERE `id` = '$id'",$con);
