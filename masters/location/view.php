...
$sql = "SELECT * FROM `location` WHERE `delete`='0'";
$getData = mysql_query($sql,$con) or die(mysql_error());
$Num_Rows = mysql_num_rows($getData);
	$Per_Page = 25;   // Per Page
	include('../../pagination/pagination.php');
	$folder= 'masters/location/view';
	$title = 'Location';
...
?>
<div id="myTitle">
<div class="title">View All Location</div>
<div class="strip">
<span>Dashboard</span>
<span>Location</span>
<span>View</span>
...
{
?>
<button class="button blue" onclick="getModule('masters/location/index','manipulateContent','viewContent','Location')"> <i class="plus"></i>New Location</button>&nbsp;
<?php 
} 
?>
...
{
?>
<button class="button red" onclick="deleteData('location','Location')"> <i class="delete-icon"></i>Delete</button>&nbsp;
<?php 
} 
