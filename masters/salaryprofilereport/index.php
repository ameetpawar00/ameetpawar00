...
<div class="strip">
    <span>Dashboard</span>
    <span>Salary Profile Report</span>
    ...
    <div class="add-new blue-border">
        <div class="form-head blue">
            <div class="head-title">
                <i class="add-form"></i>
                Download Salary Profile Report</div>
        </div>
        <form action="masters/salaryprofilereport/excelDownload.php" method="post" target="_blank" >
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <th>Select Month<span>*</span></th>
                    <td>
                        <select class="input drop-down large" name="month" id="month" disabled>
                ...
                <tr>
                    ...
                    <td>
                        <select class="input drop-down large" name="year" id="year" disabled>
                            <?php
                                for($i = 2014;$i <= date("Y") ;$i++)
                                {
                                    ...
                                    ?>
                                    <option value="<?php echo $i; ?>" <?=$selc?>><?php echo $i; ?></option>
                                    <?php
                                }
                            ?>
                        </select>
