...
mysql_query("INSERT INTO `document`(`name`,`type`,`description`, `createdate`, `modifieddate`, `updatedby`, `delete`) VALUES ('$post[0]','$post[1]','$post[2]','$datetime','$datetime','$hrmloggedid','0')",$con) or die(mysql_error());
$id = mysql_insert_id();
...
DocumentSaved Successfully</div>
