...
echo "UPDATE `companydetail` SET `name`='$post[0]', `address`='$post[2]',`email`='$post[1]',`city`='$post[4]',`state`='$post[3]',`pincode`='$post[5]',`panname`='$post[6]',`footnote`='$post[7]',`logo`='$post[8]',`updatedate`='$datetime',`updatedby`='$hrmloggedid' WHERE `id` = '$id'";
