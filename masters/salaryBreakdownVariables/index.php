            ...
            <tr>
                ...
                <td>
                    <?php
                        ...
                        {
                            $sdelVal.=<<<AAA
                                        <option value="$arrayTypeKey">$arrayTypeValue</option>
AAA;
            ...
            <tr>
                <td colspan="4" style="text-align:center">
                    <button class="button green" onclick="SaveData('masters/salaryBreakdownVariables/save','dept','2','','','couResp','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i>Save Variable</button>
