...
mysql_query("UPDATE `typeofasset` SET `name`='$post[0]',`modifieddate` = '$datetime', `updatedby`  = '$hrmloggedid' WHERE `id` = '$id'",$con);
...
<td class="link-blue" onclick="getModule('masters/typeofasset/edit?id=<?php echo $id?>&i=<?php echo $i?>','manipulateContent','viewContent','Assets')"><?php echo $row['name'] ?></td>
