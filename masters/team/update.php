...
mysql_query("UPDATE `team` SET `name` = '$post[0]', `leader` = '$post[1]', `modifieddate` = '$datetime', `updatedby` = '$loggeduserid', `delete` = '0', `department_id` = '$post[3]', `desc` = '$post[4]', `self_attendance` = '$post[5]' WHERE `id` = '$id'",$con) or die(mysql_error());
