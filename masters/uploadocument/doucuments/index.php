...
if($chkExt == 'doc' || $chkExt == 'docx' || $chkExt == 'pdf' )		{
...
document.getElementById('output').innerHTML='File Not Valid Only .doc,docx or pdf files' ;
...
?>
<script type="text/javascript">
document.getElementById('output').innerHTML='Letter Success Fully Uploaded';
