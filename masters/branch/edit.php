...
<button class="button green" onclick="SaveData('masters/branch/update?id=<?php echo $id;?>&i=<?php echo $i;?>','dept','2','<?php echo $i;?>','','couResp','2');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i>Update</button>
