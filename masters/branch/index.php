...
<button class="button green" onclick="SaveData('masters/branch/save','dept','2','','','couResp','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i>Save Location</button>
