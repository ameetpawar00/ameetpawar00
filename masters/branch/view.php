...
$sql = "SELECT * FROM `branch` WHERE `delete`='0'";
$getData = mysql_query($sql,$con) or die(mysql_error());
$Num_Rows = mysql_num_rows($getData);
	$Per_Page = 25;   // Per Page
	include('../../pagination/pagination.php');
	$folder= 'masters/branch/view';
	$title = 'branch';
...
?>
<div id="myTitle">
<div class="title">View All Branch</div>
<div class="strip">
<span>Dashboard</span>
<span>Branch</span>
<span>View</span>
...
{
?>
<button class="button blue" onclick="getModule('masters/branch/index','manipulateContent','viewContent','Branch')"> <i class="plus"></i>New Branch</button>&nbsp;
<?php 
} 
?>
...
{
?>
<button class="button red" onclick="deleteData('branch','Branch')"> <i class="delete-icon"></i>Delete</button>&nbsp;
<?php 
} 
...
{
?>
<td class="link-blue" onclick="getModule('masters/branch/edit?id=<?php echo $row[0]?>&i=<?php echo $i?>','manipulateContent','viewContent','Branch')"><?php echo $row['name'] ?></td>
<?php 
} 
else
{
