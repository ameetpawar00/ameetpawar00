...
$getData = mysql_query("SELECT city.id,city.name,city.modifieddate,employee.name FROM city,employee WHERE city.updatedby = employee.id AND city.delete = '0' AND branch.name LIKE '$term%' ORDER BY branch.name ",$con) or die(mysql_error());
?>
