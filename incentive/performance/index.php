...
<tr><th >Designation*</th>
	<td >
	<select class="input drop-down large" id="incea0"  title="isNotNull" name="req" onchange="incentiveexist('incentive/performance/check.php?id=<?php echo $id?>','couResp','incea0','incea2','incea3','')">
	...
	?>
		...
		<th>Action *</th>
		<td>
		<select class="input drop-down large" id="incea1"  title="isNotNull" name="req" onchange="incentiveexist('incentive/performance/check.php?id=<?php echo $id?>','couResp','incea0','incea2','incea3','')">
...
<th>From *</th>
<td><input type="text" title="isNotNull" value="<?php echo $rowData['from']?>" id="incea2" class="input medium" onkeypress="return chkDecimal(event,'showError0')" name="req" onblur="incentiveexist('incentive/performance/check.php?id=<?php echo $id?>','couResp','incea0','incea2','incea3','')">
<span id="showError0" class="showError"></span>

</td>
<th>To *</th>
<td><input type="text" title="isNotNull" value="<?php echo $rowData['to']?>" id="incea3" class="input medium" onkeypress="return chkDecimal(event,'showError1')" name="req" onblur="incentiveexist('incentive/performance/check.php?id=<?php echo $id?>','couResp','incea0','incea2','incea3','')" >
...
<tr >
<th>Performance*</th>
<td><input type="text" title="isNotNull" value="<?php echo $rowData['performance']?>" id="incea6" class="input medium" name="req" >

</td>
<th>OutOf *</th> 
<td><input type="text" title="isNotNull" value="<?php echo $rowData['outof']?>" id="incea7" class="input medium" name="req" >
<span id="showError2" class="showError"></span>
</td>
</tr>
...
<button class="button green" onclick="SaveData('<?php echo $url?>','incea','8','<?php echo $i;?>','','couResp','<?php echo $what?>');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')"><i class="save-icon"></i><?php if($edit == 1){ ?> <span> Update </span> <?php } else { ?> <span> Save </span> <?php } ?> </button>
