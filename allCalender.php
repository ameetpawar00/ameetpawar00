<div id="CALENDAR" class="calendar" style="visibility:hidden;	z-index: 20000000000000;-moz-box-shadow: 0 0 3px #000; -webkit-box-shadow: 0 0 3px #000;">
	...
	<table border="0" cellpadding="3" cellspacing="0" width="205px;" class="calc">
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<img src="img/previous.png"/> </td>
					<td class="hdr" width="60%" align="center" valign="middle" style="vertical-align:middle">
					<form>
<select id="selMonth" onchange="updateFromSel();" class="input" style="width:50px;background:#fff;color:#222;border:0px;">
						<option>Jan</option>
						<option>Feb</option>
						<option>Mar</option>
						<option>Apr</option>
						...
						<select id="selYear" onchange="updateFromSel();"  class="input" style="width:50px;background:#fff;color:#222;border:0px;">
						<option>2020</option>
						<option>2019</option>
						<option>2018</option>
						<option>2017</option>
		...
		<tr class="calenderRow">
			<td id="C0" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C6" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr class="calenderRow">
			<td id="C7" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C13" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr class="calenderRow">
			<td id="C14" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C20" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr class="calenderRow">
			<td id="C21" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C27" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr class="calenderRow">
			<td id="C28" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C34" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr id="LastRow" class="calenderRow">
			<td id="C35" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
			...
			<td id="C41" onclick="choose(this);" style="font-weight:bold;color:#222"></td>
		</tr>
		<tr>
			<td colspan="7" style="background:transparent;color:#BD2222;border-top:1px #eee solid">
			<div style="float:right">
			<img src="img/close-notif-hover.png" onclick="document.getElementById('CALENDAR').style.visibility='hidden';" style="cursor:pointer" />
			</div>
			 </td>
		</tr>
	</table>
