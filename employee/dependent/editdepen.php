...
<td style="color:#000;"><input class="input medium" name="req" title="isNotNull" id="edepen<?php echo $id?>3" style="width:150px" type="text" value="<?php echo $fetchData[6]?>" /></td>
<td style="color:#000;"><textarea class="input huge" id="edepen<?php echo $id?>4">value="<?php echo $fetchData[7]?>"</textarea></td>
<td style="color:#000;"><input class="input medium" name="req" title="isNotNull" id="edepen<?php echo $id?>5" style="width:150px" type="text" value="<?php echo $fetchData[8]?>" /></td>
<td>

<img src="img/icons/icons11.png" title="Update" height="20" width="17" onclick="SaveData('employee/dependent/updatedepen?id=<?php echo $id;?>&i=<?php echo $i;?>','edepen<?php echo $id?>','5','','','','10')" />&nbsp;&nbsp;&nbsp;&nbsp;
