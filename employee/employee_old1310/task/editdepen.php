...
<td style="color:#000"><input name="" title="isNotNull" id="edepen<?php echo $id?>2" type="" readonly="readonly" class="inputCalendar" style="width:200px" onclick="openCalendar(this);" value="<?php echo $fetchData[3]?>"/> </td>
