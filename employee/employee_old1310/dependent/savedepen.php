...
mysql_query("INSERT INTO `dependent` (`id`, `name`, `relationshipid`, `dob`, `eid`, `createdate`,`updatedby` ,`delete`) VALUES ('', '$post[0]', '$post[1]', '$post[2]', '$eid', '$datetime', '$hrmloggedid','0')",$con) or die(mysql_error());
$id = mysql_insert_id();
