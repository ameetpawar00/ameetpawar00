...
$eid = $_GET['eid'];
$name = $_GET['name'];
$getData = mysql_query("SELECT noteline.subject,noteline.createdate,noteline.updatedby,noteline.note,employee.name FROM noteline,employee WHERE noteline.employee = '$eid' AND employee.id = noteline.updatedby" ,$con) or die(mysql_error());
