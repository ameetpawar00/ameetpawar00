...
<div style="width:720px;background:#069;text-align:center;height:100px;color:#fff;;font-size:30px;line-height: 1.4em" >
	WEBRICKS SERVICES</br>
	Computing Inteligence
	<!--<img src="http://gocrm.co.in/hrm/img/companylogo.png" alt="" width="150" style="margin:20px">-->
</div>		
</td>
		</tr>	<tr>
...
?>
<form action="http://www.skaudiosolutions.com/hrm/dom/www/mypdf.php" method="post" target="_blank" >
