...
$getData = mysql_query("SELECT `emp_education`.`id`, emp_education.name,emp_education.subject,emp_education.grade,emp_education.year,emp_education.way,emp_education.description from `emp_education` WHERE  emp_education.delete = '0' AND emp_education.id = '$id' ",$con) or die(mysql_error());
...
<td><img src="img/icons/icons11.png" title="Update" height="20" width="20" onclick="SaveData('employee/education/updateedu?id=<?php echo $id;?>&i=<?php echo $i;?>','eedu<?php echo $id?>','6','','','couResp','2')" />&nbsp;&nbsp;&nbsp;&nbsp;
