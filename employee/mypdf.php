...
$employee = base64_decode($_GET['employee']);
$salId = base64_decode($_GET['id']);
...
?>
<form action="http://www.skaudiosolutions.com/hrm/dom/www/mypdf.php" method="post" name="slipHtml" style="float:right" target="slipFrame"  >
<textarea style="display:none" name="html"><?php echo $slipHtml?></textarea>
<input type="hidden" name="filename" value="<?php echo $pdfName?>"/>
<input type="button" name="print" value="Print" class="green button" onclick="PrintDiv('mySalslip')">
<input type="submit" name="submit" value="Download As Pdf" class="blue button" style="display:none">
<input type="button" value="Back" class="red button" onclick="ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')" > 
</form>
<iframe style="height:0px;width:0px;"  id="slipFrame" name="slipFrame" scrolling="no" style="display:none" frameborder="0"></iframe>
