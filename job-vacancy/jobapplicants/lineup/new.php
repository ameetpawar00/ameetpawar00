...
$select=mysql_query("select * from jobapplicants where id = '$applicantid'");
...
<button class="button green" onclick="SaveData('job-vacancy/jobapplicants/lineup/savelineup?applicantid=<?php echo $applicantid;?>&jobid=<?php echo $jobid;?>','lin','6','','','couResp','1');"><i class="save-icon"></i>Save</button>
