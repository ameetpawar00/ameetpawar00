...
$chkExt = end(explode('.',$name));
	if($chkExt == 'doc' || $chkExt == 'docx' || $chkExt == 'pdf' || $chkExt == 'txt' || $chkExt == 'text' || $chkExt == 'xls')
		{
...
//document.getElementById('output').innerHTML='File Not Valid Only .doc,docx,pdf,xls,txt files';
...
?>
<script type="text/javascript">
document.getElementById('output').innerHTML='Document Success Fully Uploaded';
document.getElementById('viewLetter').style.display='block';
document.getElementById('viewLetter').href='<?php echo $target ;?>';
window.parent.document.getElementById("<?php echo $_GET['respid'] ?>").value='<?php echo $target ;?>';
...
<a style="display:none;font-size:10px;color:green" id="viewLetter" target="_blank"> View Letter</a>
  </td>
  </tr>
</table>
</form>
