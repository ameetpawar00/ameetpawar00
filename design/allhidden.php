...
<div class="close" style="z-index:1000" onclick="document.getElementById('viewmoodleContent').innerHTML='';document.getElementById('manipulatemoodleContent').innerHTML='';$('#moodle').animate({left:'115%'});"></div>
