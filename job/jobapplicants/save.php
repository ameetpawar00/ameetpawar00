...
mysql_query("INSERT INTO `jobapplicants`(`jobid`, `name`, `contact`, `email`, `qualification`, `experience`, `source`, `resumefile`, `description`, `creatdate`, `updatedate`, `updatedby`,`jobtitel`) VALUES ('$jobid','$post[1]','$post[2]','$post[3]','$post[4]','$post[5]','HRM','$post[9]','$post[8]','$datetime','$datetime','$hrmloggedid','$post[0]')",$con) or die(mysql_error());
$id = mysql_insert_id();
