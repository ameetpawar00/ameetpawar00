...
$abc=count($sumtotal);
if ($abc>0) {
echo " <div style=font-size:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana; color:green>Total Expences = $sumtotal[0]</div>";
}
?>
</td>
<td style="width:80%" align="right">
<button class="button red">From Date <input name="datepicker" id="selectedDate" type="" value="From Date" readonly="readonly"  class="inputCalendar" style="width:200px" onclick="openCalender('calenderid1','selectedDate')">
<div class="calender" id="calenderid1"></div></button>
<button class="button red">To Date <input name="datepicker" id="to" type="" readonly="readonly" value="To Date" class="inputCalendar" style="width:200px" onclick="openCalender('calenderid2','to')">
<div class="calender" id="calenderid2"></div></button>

<button class="button blue" onclick="getModule('management/inventory/search?datevalue='+document.getElementById('selectedDate').value+'&datevalueto='+document.getElementById('to').value,'manipulateContent','viewContent','Inventory')"> Go</button>&nbsp;
