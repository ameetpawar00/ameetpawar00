...
?>
<div id="myTitle">
    <div class="title">Cash Leaves Requests</div>
    <div class="strip">
        <span>Dashboard</span>
...
AAA;
                ...
                <td>
                    <div class="button green" style="cursor:pointer;padding:4px;" onclick="getModule('management/salary/story/view?eid=<?php echo $eid?>&amp;name=<?php echo $name?>','manipulatemoodleContent','viewmoodleContent','Story Line')">Story</div></td>
            </tr>
            <?php
            $i++;
        }
