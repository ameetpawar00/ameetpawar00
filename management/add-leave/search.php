...
$sql = "SELECT * FROM `inventory` WHERE date = '$datepicker' AND `delete`='0'";
...
<button class="button red">Select Date <input name="req" id="selectedDate" type="" readonly="readonly" value="" class="inputCalendar" style="width:200px" onclick="openCalender('calenderid','selectedDate')">
